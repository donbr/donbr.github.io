...
Projects are defined inline as a simple array in `ProjectsPage.tsx` (lines 155-247). Each project has:
- title
- description
- tags (with color mapping defined in tagColorMap at lines 24-75)
- Optional: demoUrl, codeUrl, huggingFaceUrl, detailUrl

The ProjectCard component is also defined inline in ProjectsPage.tsx (lines 15-152).

### Layout Component

The Layout component (`src/components/layout/Layout.tsx`) wraps all pages and provides:
- Navigation bar with links to sections (About, Expertise, Publications, Certifications, Projects, Concepts, Teaching, Contact, Graph Demos)
