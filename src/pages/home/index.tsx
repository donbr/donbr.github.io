      ...
      <section id="contact" className="bg-white py-16">
          <div className="max-w-6xl mx-auto px-4">
              ...
              <div className="bg-gray-50 rounded-lg shadow-md p-6 max-w-lg mx-auto">
                  ...
                  <div className="flex justify-center space-x-4">
                      <a href="https://www.linkedin.com/in/donbranson/" className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-500">
                          Connect on LinkedIn
                      </a>
                      <a href="https://github.com/donbr" className="bg-gray-800 text-white px-6 py-2 rounded-md hover:bg-gray-700">
                          Follow on GitHub
                      </a>
                  </div>
              </div>
