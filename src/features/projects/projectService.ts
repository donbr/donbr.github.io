...
const projects: Project[] = [
  ...
  {
    id: 'transformers-demo',
    title: 'Transformers Demo',
    description: 'A demo showcasing transformer-based models on sample data.',
    tags: ['Machine Learning', 'Transformers', 'Demo'],
    link: '/projects/transformers-demo'
  }
];
...
const projectDetails: Record<string, ProjectDetail> = {
  ...
  'transformers-demo': {
    ...
    tags: ['Machine Learning', 'Transformers', 'Demo'],
    link: '/projects/transformers-demo',
    fullDescription: 'A demo that showcases how transformer-based models process and generate text in an interactive environment.',
    technologies: ['React', 'TensorFlow.js', 'Transformers', 'Demo'],
    githubUrl: 'https://github.com/donbr/donbr.github.io'
  }
};
